...
public class U {
	...
	public static double sumNodes(String xpath, Element d) throws Exception {
		double sum = 0;
		for (Node n : getNodes(xpath, d)) {
			sum += new Double(n.getTextContent());
		}
		return sum;
	}
	
	public static double avgNodes(String xpath, Element d) throws Exception {
		double sum = 0;
		int count = 0;
		for (Node n : getNodes(xpath, d)) {
			sum += new Double(n.getTextContent());
	...
	public static int countNodes(String xpath, Element d) throws Exception {
		int count = 0;
		for (Node n : getNodes(xpath, d)) {
			count++;
		}
